...
The main task of hands-on exercise 2 is to learn how to compute spatial weights using R. We are mainly using:
...
### **2.5.2 Creating (ROOK) contiguity based neighbours**
...
#### 2.5.3.1 Plotting Queen contiguity based neighbours map
...
#### 2.6.2.1 Plotting fixed distance weight matrix
...
### **2.7.1 Row-standardised weights matrix**
...
## **2.8 Application of Spatial Weight Matrix**
