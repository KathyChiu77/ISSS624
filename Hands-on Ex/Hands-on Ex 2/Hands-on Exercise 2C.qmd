...
In this hands-on exercise, we will compute Global and Local Measure of Spatial Autocorrelation (GLSA) by using **spdep** package. By the end to this hands-on exercise, you will be able to:
...
## **2.6 Cluster and Outlier Analysis**
...
## **2.7 Creating a LISA Cluster Map**
