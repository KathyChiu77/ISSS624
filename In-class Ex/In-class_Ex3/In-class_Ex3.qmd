...
Next, a constant distance value of 50m is added into intra-zones distance (which won't affect the miximum distance).
...
## **3.7 Preparing Origin and Destination Attributes**
...
## **3.8 Calibrating Spatial Interaction Models**
